...
<head>
    ...
    <meta name="description" content="{{\App\Seo::find(1)->description}}">
    <meta name="keywords" content="{{\App\Seo::find(1)->keyword}}">
    <!-- PAGE TITLE -->
    <title>{{ \App\General::find(1)->name }}</title>
    <link rel="shortcut icon" href="{{asset('images/logo/' . $logo->icon)}}"/>
    <!-- BOOTSTRAP CSS -->
    ...
    <link rel="stylesheet" href="assets/boss/css/style.php?color={{\App\General::find(1)->color }}">
    <!-- RESPONSIVE CSS -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="logo">
                        <a href="{{url('/')}}">
                            <img style="height: 50px; width: 50px" src="{{asset('images/logo/' . $logo->logo)}}" title="{{ \App\General::find(1)->name }}">
                        </a>
                    </div>
                        ...
                        <div class="navbar navbar-nobg">
                            ...
                            <div class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a class="smoth-scroll" href="#work">Kisu Kormu</a>
                                    </li>
                                    <li><a class="smoth-scroll" href="#testimonial">testimonial</a>
                                    </li>
                                    <li><a class="smoth-scroll" href="#pricing">statistics</a>
                                    </li>
                                    ...
                                    @foreach($menus as $menu)
                                        <li><a class="smoth-scroll" href="">{{$menu->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="header-text text-center">
                                ...
                                <a class="hire-btn smoth-scroll wow fadeInUp" data-wow-delay="1.4s" href="{{ route('login') }}">Login</a>
                                <a class="hire-btn smoth-scroll wow fadeInUp" data-wow-delay="1.4s" href="{{ route('register') }}">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
